...
//					postData.append(param.getValue());
	...
	public void test(JSONObject commonParams, URL url) throws JSONException {
		...
		try {
			...
			DataOutputStream out_st = new DataOutputStream(con.getOutputStream());
			out_st.writeUTF(reqParam.toString());
			out_st.flush();
			out_st.close();
