...
$(document).ready(function () {
    ...
    if (INTERFACE.USER != "") {
        if (INTERFACE.TYPE == "REAL") {
            ajax_url = "http://emr.hanheart.com/cmcnu/.live";
            ajax_nu_url = "http://emr.hanheart.com/eform";
            HIS_EPH = "HIS205";
        } else {
            ajax_url = "http://emrtst.hanheart.com/cmcnu/.live";
            ajax_nu_url = "http://emrtst.hanheart.com/eform";
            HIS_EPH = "HIS205EDU";
        } 
    }
   ...
   $("#_laboratorySearch").click(function(){
	   ...
	   var srchflag = $('#_laboratoryCheck option:selected').val();
	    if(prcpexecdeptcdid == "" || srchflag == ""){
		   ...
		   $.ajax({
	           url: ajax_url,
	           type: 'post',
	           data: 'submit_id=DRMRF00126&business_id=mr&instcd=205&fromdd='+ fromdd +'&todd='+ todd 
	           ...
	           success: function (result) { 
	               if ($(result).find('list').length > 0) {
	                   $(result).find('list').each(function(){ 
                           ...
                           ul.find("._laboratoryPrcpdd").text($(this).find('prcpdd').text()); // 처방일자
    ...
    function checkReadyConsent(){
        ...
        $.ajax({
            url: "http://emr.hanheart.com/cmcnu/webapps/mr/mr/formmngtweb/.live",
            type: 'post',
            data: 'submit_id=DRMRF00122&business_id=mr&instcd=205&startdate='+ timeMinus +'&enddate='+ time +'&userdeptcd='+ getLocalStorage("userDeptCode"),
            dataType: 'xml',
            timeout: 40000,
            success: function (result) { 
            ...
            $.ajax({
            	...
            	if(data.result==true){
                    $.ajax({
                        url: ajax_url,
                        type: 'post',
                        data: 'submit_id=DXMRF00115&business_id=mr&instcd=205&ocrtag=' + jsObj.ocrTag + "&updtdt=" + new Date().YYYYMMDDHHMMSS() + "&updtdeptcd=" + getLocalStorage("userDeptCode") +
    ...
    $("#_requestSearch").on("click", function () {
        ...
        if (checkVal < -90) {
            ...
            if (searchRequestConditionCheck()) { 
                ...
                $.ajax({
                    url: "http://emr.hanheart.com/cmcnu/webapps/mr/mr/formmngtweb/.live",
                    data: "submit_id=DRMRF00123&business_id=mr&instcd=205&pid=&fromdd="+fromdd+"&todd="+todd+"&orddeptcd="+orddeptcd+"&orddrid="+orddrid
                    ...
                    ul.on("click", function () {
                        ...
                        if (data != "") {
                            ...
                            if (consentInfo.consentState == "ELECTR_CMP") { // 완료서식
                                ...
                                consents[consents.length] = JSON.parse(data);//JSON.parse(data);
                                COMMON.LOCAL.eform.consent = consents;  
...
//        }
    ...
    $("#_btnPopupOk").on("click", function () {
        ...
        if (pw != "" && pw != undefined) {
            var ITnadePlugins = new ITnadePlugin();
             ITnadePlugins.setConnect("10.10.0.72", 6001, getLocalStorage("userId"), pw);
            
            // COMMON.plugin.certDown(id, pw, consentOnClickEvent,
            // errorHandler);
        } else {
        ...
        if (id != "" && pw != "") {
            ...
            if (checkVal < -90) {
   			 ...
   			 $.ajax({
                    url: ajax_url,
                    type: 'post',
                    data: 'submit_id=DRMRF00119&business_id=mr&userid=' + id + '&pwd=' + pw + '&instcd=205&syscd=' + HIS_EPH,
                    dataType: 'xml',
                    timeout: 40000,
                    success: function (result) { 
...
//                                    applyduty = "N";
                            ...
                            if(applyduty == "Y"){
                            	$.ajax({
                        			url: 'http://emr.hanheart.com/cmcnu/.live',
                        			type: 'post',
                        			data: 'submit_id=DRZSU11708&business_id=zz&dutplceinstcd=205&dutplcecd=' + getLocalStorage("userDeptCode") + '&userid=' + getLocalStorage("userId"),
                        			dataType: 'xml',
                        			async: false,
                        			timeout: 10000,
                        			success: function (result) {		
...
//    var ITnadePlugins = new ITnadePlugin();
//    ITnadePlugins.setConnect("172.17.100.153", 6001, "94650157", "paul2015^^");
    pageInit();
...
function searchCheckupDept() { 
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00124&business_id=mr&instcd=205",
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function searchCheckupRoom(DeptCd) { 
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00125&business_id=mr&instcd=205&basesuppdeptcd="+DeptCd,
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function searchWard() {
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00113&business_id=mr&instcd=205&orddeptflag=W&drflag=M&selecttype=A&orddeptflag=W",
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function searchInEmerOperClnDept() {
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00113&business_id=mr&instcd=205&orddeptflag=D&drflag=M&selecttype=A",
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function searchOutPatientClnDept() {
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00113&business_id=mr&instcd=205&orddeptflag=O&drflag=M&selecttype=A",
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function searchFindClnDept() {
    $.ajax({
        url: ajax_url,
        data: "submit_id=DRMRF00113&business_id=mr&instcd=205&orddeptflag=A&drflag=M&selecttype=A",
        type: 'get',
        dataType: 'xml',
        timeout: 40000,
        success: function (result) {
...
function InpatientSearch_submit() {
    ...
    if (checkVal < -90) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=I&pid=&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=" + dortorId + "&atdoctid=-&elbulbodstat=-&wardcd=" + ward + "&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today,
            type: 'get',
            dataType: 'xml',
            timeout: 30000,
            success: function (result) {
...
function outPatientSearch_submit() {
    ...
    if (checkVal < -90) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=O&pid=&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=" + dortorId + "&atdoctid=-&elbulbodstat=-&wardcd=&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today,
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
...
function emergencySearch_submit() {
    ...
    if (checkVal < -90) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=E&pid=&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=-&atdoctid=-&elbulbodstat=-&wardcd=&patflagstat=-&opstatcd=-&srchflag=" + searchType + "&currentdd=" + today,
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
                ...
                if ($(result).find('list').length > 0) {
                    $(result).find('list').each(function () {
                        ...
                        patient.hometel = $(this).find('hometel').text();
                        patient.mpphontel = $(this).find('mpphontel').text(); 
                        patient.ClnDeptCode = $(this).find('erorddeptcd').text();
                        patient.ClnDeptName = $(this).find('erorddeptnm').text();
                        patient.ChargeId = $(this).find('atdoctid').text();
...
function operationSearch_submit() {
    ...
    if (checkVal < -90) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=P&pid=&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=" + Doctor + "&atdoctid=-&elbulbodstat=-&wardcd=&patflagstat=-&opstatcd=" + OperationType + "&srchflag=-&currentdd=" + today,
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
...
function findPatientSearch() {
    ...
    var ajax_data = "";
    if (searchType == "I") {
        ajax_data = "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=I&hngnm=" + PatientName + "&pid=" + PatientCode + "&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=-&atdoctid=-&elbulbodstat=-&wardcd=-&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today;
    } else if (searchType == "O") {
        ajax_data = "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=O&hngnm=" + PatientName + "&pid=" + PatientCode + "&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=-&atdoctid=-&elbulbodstat=-&wardcd=-&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today;
    } else if (searchType == "E") {
        ajax_data = "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=E&hngnm=" + PatientName + "&pid=" + PatientCode + "&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=-&atdoctid=-&elbulbodstat=-&wardcd=-&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today;
    } else {
        ajax_data = "submit_id=DRMRF00116&business_id=mr&instcd=205&ordtype=P&hngnm=" + PatientName + "&pid=" + PatientCode + "&orddd=" + clnDate + "&orddeptcd=" + clnDept + "&orddrid=-&atdoctid=-&elbulbodstat=-&wardcd=-&patflagstat=-&opstatcd=-&srchflag=-&currentdd=" + today;
    }
    COMMON.plugin.wifiCheck(wifiCheckFn);
...
function searchNowriteConsent() {
    ...
    if (checkVal < -90) {
        ...
        $.ajax({
            url: ajax_url, //"http://emr014edu.cmcnu.or.kr/cmcnu/webapps/mr/mr/formmngtweb/.live?submit_id=DRMRF00121&ep_interface=emr&business_id=mr&instcd=014&pid=1605576&orddd=20190517&cretno=1&ordtype=I", 
            data: "business_id=mr&submit_id=DRMRF00121&instcd=205&pid=" + detail.PatientCode + "&orddd=" + detail.AdmissionDate + "&cretno=" + detail.Cretno + "&ordtype=" + detail.VisitType, //파라미터확인 //"submit_id=DRMRF00121&business_id=mr&instcd=205&pid=1605576&orddd=20190517&cretno=1&ordtype=I", 
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
            	//console.log("url:::"+ ajax_url+"?"+"business_id=mr&submit_id=DRMRF00121&instcd=205&pid=" + detail.PatientCode + "&orddd=" + detail.AdmissionDate + "&cretno=" + detail.Cretno + "&ordtype=" + detail.VisitType );
                $("#_relationConsentList li").remove();
                if ($(result).find('item').length > 0) {
                    var i = 0;
                    $(result).find('item').each(function () {
                      ...
                      //  consent.ocrTag = CreateOcrTag();
                        ...
                        li.find(".list_txt").on("click", function () {
                            ...
                            // 여기
                            var consentInfo = $(this).parent().attr("attr-data"); 
                            var ocrAdd = JSON.parse(consentInfo);
                            ocrAdd.ocrTag = CreateOcrTag();
                            consentInfo = JSON.stringify(ocrAdd);
    ...
    if (searchType == "S") {
        ...
        if (checkVal < -90) {
            ...
            $.ajax({
                ...
                // -- 비급여 2차수정
                data: "submit_id=DRMRF00117&business_id=mr&instcd=205&deptcd=" + deptCd + "&userid=" + getLocalStorage("userId")+ "&ioflag="+detail.VisitType,  
                type: 'get',
                dataType: 'xml',
                success: function (result) {
        ...
        if (checkVal < -90) {
            ...
            $.ajax({
                url: ajax_url,
                // 비급여 2차
                data: "submit_id=DRMRF00118&business_id=mr&instcd=205&userid=" + userId  + "&ioflag="+detail.VisitType,
                type: 'get',
                dataType: 'xml',
                success: function (result) {
                    var SearchResult = new Object();
        ...
        if (checkVal < -90) {
            ...
            $.ajax({
                url: ajax_url, // ajax_url,
                data: "submit_id=DRMRF00120&business_id=mr&instcd=205&formnm=" + keyword + "&userid=" + getLocalStorage("userId"), // "submit_id=DRMRF00120&ep_interface=emr&business_id=mr&instcd=205&formnm="+keyword,
                type: 'get',
                dataType: 'xml',
                success: function (result) {
                    //console.log(ajax_url + "?" + "submit_id=DRMRF00120&business_id=mr&instcd=205&formnm=" + keyword) // "submit_id=DRMRF00120&ep_interface=emr&business_id=mr&instcd=205&formnm="+keyword)
                    if ($(result).find('item').length > 0) {
                        $(result).find('item').each(function () {
        ...
        if (checkVal < -90) {
            ...
            $.ajax({
                url: ajax_url, // ajax_url,
                data: "submit_id=DRMRF00120&business_id=mr&instcd=205&formnm=&userid=" + getLocalStorage("userId"), // "submit_id=DRMRF00120&ep_interface=emr&business_id=mr&instcd=205&formnm="+keyword,
                type: 'get',
                dataType: 'xml',
                success: function (result) {
                    //console.log(ajax_url + "?" + "submit_id=DRMRF00120&business_id=mr&instcd=205&formnm=" + keyword) // "submit_id=DRMRF00120&ep_interface=emr&business_id=mr&instcd=205&formnm="+keyword)
    ...
    if ($.isEmptyObject(consents)) {
        ...
        if (type == "S" || type == "B") {
                ...
                if (ecoval.eco == "N" || ecoval.eco == "" || ecoval.eco == undefined) {
                	...
                	if(ecoval.path == "NONPAY"){
                		var setno = ecoval.itemindxseq;    
                	     $.ajax({
                             url: ajax_url, // ajax_url,
                             data: "submit_id=DRMRF00127&business_id=mr&instcd=205&setno=" + setno, 
                             type: 'get',
                             async : false,
                             dataType: 'xml',
                             success: function (result) { 
            ...
            for (var i = 0; i < consents.length; i++) {
                ...
                var key = $("#_searchKeyword").val().trim();
                key = key.toUpperCase();
                var formnameText = consent.FormName.toUpperCase() + "[" + consent.FormExtnNm + "]";

                if (key != "" && formnameText.indexOf(key) > -1) {
...
function makeCommmonParamForEform() {
    ...
    if (localStorage.getItem("jobkindcd").substring(0, 2) == "03") {
        ...
        url = "http://emr.hanheart.com/cmcnu/webapps/mr/mr/formmngtweb/.live?submit_id=DRMRF02317&business_id=mr&userid=" + getLocalStorage("userId");
    }
    var viewerCommonParams = {
            ...
            "logo_imge": "http://emr.hanheart.com/cmcnu/webapps/images/report/biglogo205.png",
            "docSignImgUrl": url,
    ...
    for(var key in patient){
    	...
    	//console.log(" patientIdx key : "+ key); 
    	//console.log(" patientIdx value : "+ patient[key]);  
    } 
...
function searchCharge(deptcd) {
    if (deptcd == "" || deptcd == undefined) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00114&deptcd=" + deptcd + "&instcd=205&drflag=A",
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
...
function searchDoctor(deptcd) {
    if (deptcd == "" || deptcd == undefined) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00114&business_id=mr&deptcd=" + deptcd + "&instcd=205&drflag=M",
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
...
function SearchOutDoctor(deptcd) {
    if (deptcd == "" || deptcd == undefined) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF00114&business_id=mr&deptcd=" + deptcd + "&instcd=205&drflag=",
            type: 'get',
            dataType: 'xml',
            timeout: 40000,
            success: function (result) {
...
function searchOperDoctor(clnDept){
	 if (clnDept == "" || clnDept == undefined) {
         ...
         if (checkVal < -90) {
             ...
             $.ajax({
                 url: ajax_url,
                 data: "submit_id=DRMRF00114&business_id=mr&deptcd=" + clnDept + "&instcd=205&drflag=M",
                 type: 'get',
                 dataType: 'xml',
                 timeout: 40000,
                 success: function (result) {
...
function CreateOcrTag() {
    ...
    if (checkVal < -90) {
        ...
        var ymd = "";
        $.ajax({
            url:  'http://emr.hanheart.com/eform' + '/biz/nu/member/viewer/eForm25/consent/nowtime/get',
            type: 'post',
            timeout: 40000,
            async: false,
        }).done(function (data) {
        ...
        $.ajax({
            url: ajax_url,
            data: "submit_id=DRMRF02318&instcd=205&business_id=mr&ocrseqcnt=1",
            type: 'get',
            async: false,
            dataType: 'xml',
            timeout: 40000,
